...
.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$httpProvider',
	...
	.state('logged.cancelTicket',{
		...
		views : {
			...
			"body@logged" : {
				templateUrl : "assets/public/partials/cancelChoice.html",
	...
	.state('logged.cancelTicket.reader',{
		url : '/reader',
		views : {
			"header@logged" : {
				templateUrl : "assets/public/partials/navbar.html",
			...
			"body@logged" : {
				templateUrl : "assets/public/partials/cancelTicketReader.html",
				controller : 'cancelTicketCtrl',
				controllerAs : 'cancelTicket'
			}
		},
	...
	.state('logged.cancelTicket.number',{
		url : '/number',
		views : {
			"header@logged" : {
				templateUrl : "assets/public/partials/navbar.html",
			...
			"body@logged" : {
				templateUrl : "assets/public/partials/cancelTicketNumber.html",
				controller : 'cancelTicketCtrl',
				controllerAs : 'cancelTicket'
			}
		},
